...
\begin{tcolorbox}[colback=ch1blue!4,colframe=ch1blue!75!black,title={Modes de r\'egulation (correspondance / maintien)}]
\begin{itemize}
...
\tightmath{
\boxed{G_{mot}(s) = \frac{K}{(1{+}\tau_m s)(1{+}\tau_e s)} \approx \frac{K}{1 + \tau_m s}}
}
\vars{$K = \dfrac{K_T}{fR_a + K_T K_E} \approx \dfrac{1}{K_E}$ (si $f\to0$), $\tau_m = \dfrac{JR_a}{fR_a + K_T K_E}$, $\tau_e = \dfrac{L_a}{R_a}$.}
\end{tcolorbox}
